    ...
    <div class="container">
        ...
        <div class="news-grid">
            <article class="news-card pra">
                <img src="{{ asset('images/pra-flood.png') }}" alt="Logo" width="80" height="5rem">
                <h3>Pra-Banjir</h3>
            ...
            <article class="news-card saat">
                <img src="{{ asset('images/saat-flood.png') }}" alt="Logo" width="80" height="5rem">
                <h3>Intra-Banjir</h3>
            ...
            <article class="news-card pasca">
                <img src="{{ asset('images/pasca-flood.png') }}" alt="Logo" width="80" height="5rem">
